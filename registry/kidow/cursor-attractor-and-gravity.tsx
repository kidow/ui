...
import { calculatePosition } from "@/components/kidow/calculate-position"
import { parsePathToVertices } from "@/components/kidow/svg-path-to-vertices"
...
import { useMousePositionRef } from "@/components/kidow/use-mouse-position-ref"
    ...
    const registerElement = useCallback(
      (id: string, element: HTMLElement, props: MatterBodyProps) => {
        ...
        if (props.bodyType === "circle") {
          ...
          // @types/matter-js 의 rectangle 은 IChamferableBodyDefinition 을
          // 요구해 IBodyDefinition 을 그대로 넘길 수 없다.
