...
빈 저장소에서 시작해 41곳의 컴포넌트 1,687개를 모으고, 출처와 라이선스를 함께 기록해
...
| 출처 | 41 |
| 분류 | 14 |
| 데모 | 1,634 (나머지 53개는 단독 렌더 불가한 부품) |
| 제외 기록 | 32 |
| 커밋 | 66 |
...
라이선스가 재배포를 허용하는 곳만 담았다. MIT 1,610 · Apache-2.0 73 ·
...
41곳을 돌면서 같은 문제가 계속 나왔다. 다음 수집 때 먼저 확인할 것들.
