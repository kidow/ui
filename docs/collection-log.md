...
빈 저장소에서 시작해 38곳의 컴포넌트 1,554개를 모으고, 출처와 라이선스를 함께 기록해
...
| 출처 | 38 |
| 분류 | 14 |
| 데모 | 1,501 (나머지 52개는 단독 렌더 불가한 부품) |
| 제외 기록 | 31 |
| 커밋 | 58 |
...
라이선스가 재배포를 허용하는 곳만 담았다. MIT 1,477 · Apache-2.0 73 ·
...
38곳을 돌면서 같은 문제가 계속 나왔다. 다음 수집 때 먼저 확인할 것들.
...
| 인터랙션 | 282 | 폼·입력 | 100 |
| 텍스트 효과 | 217 | 버튼 | 98 |
| 레이아웃·목록 | 190 | 개발자 도구 | 57 |
| 미디어·데이터 | 174 | 마케팅 섹션 | 26 |
| 위젯 | 146 | 디바이스 목업 | 14 |
| 배경·패턴 | 125 | 코드·터미널 | 11 |
