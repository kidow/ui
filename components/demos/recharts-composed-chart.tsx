...
import { EvilComposedChart } from "@/components/kidow/recharts-composed-chart";
import { type ChartConfig } from "@/components/kidow/recharts-chart";
...
export default EvilExampleComposedChart;
