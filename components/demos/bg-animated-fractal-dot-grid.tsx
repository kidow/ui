...
// shadcn 은 use-toast 를 없애고 sonner 로 옮겼다.
import { toast } from "sonner"

import { FractalDotGrid } from "@/components/kidow/bg-animated-fractal-dot-grid"
...
`
    ...
    navigator.clipboard.writeText(configString).then(() => {
      setIsCopied(true)
      toast("Configuration Copied", { description: "The current configuration has been copied to your clipboard." })
